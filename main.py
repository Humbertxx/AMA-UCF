...
def analytics_snapshot():
    ...
    log = unwrap_response(write_sync_log(all_semesters), "write sync log")
    
    create_analytics = unwrap_response(analytics_tab(gc, all_semesters), "write to analytics tab")
    
    logging.info("analytics tab created succesfully ")
